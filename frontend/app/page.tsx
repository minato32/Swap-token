...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen pt-14 md:pt-16 flex flex-col bg-[var(--color-surface-lowest)] text-[var(--color-text-primary)] overflow-x-hidden overflow-y-auto font-body">
      {/* Ambient Background */}
